...
import { NomenglaturaDialog } from './nomenglatura-dialog/nomenglatura-dialog.component';

@Component({
  selector: 'nomenglatura-app',
  templateUrl: './nomenglatura.component.html',
  styleUrls: ['./nomenglatura.component.scss']

})
export class NomenglaturaComponent implements OnInit {


    displayedColumns: string[] = ['ID_GESTION', 'GESTION', 'TIPO', 'TIPOGESTION', 'icons'];
    ...
    loadTable() {
        ...
        this.asignacionService.getNomenglatura().then(data => {
            console.log(data);
    ...
    deletePermiso(id) {
        console.log(id);
        this.cobranzaService.activate();
        this.asignacionService.NomenglaturaDr(id.ID_GESTION).then(data => {
            this.cobranzaService.deactivate();
    ...
    add() {
        ...
        const dialogRef = this.dialog.open(NomenglaturaDialog, {
            width: '260px'
        });
