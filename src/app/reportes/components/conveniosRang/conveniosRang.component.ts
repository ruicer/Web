...
@Component({
    selector: 'conveniosRang-app',
    templateUrl: './conveniosRang.component.html',
    styleUrls: ['./conveniosRang.component.scss'],
    providers: [
        { provide: DateAdapter, useClass: AppDateAdapter },
        { provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS }
    ]
})
export class ConveniosRealizadosComponent implements OnInit {

    displayedColumns: string[] = ['FECHACONVENIO', 'SUCURSAL', 'CREDITO', 'NOMBRE', 'PROXIMOPAGO',
        'MONTOCONVENIO', 'FECHAINICIO', 'CUOTAS', 'TOTALCUO'];
    ...
    ngOnInit() {
        ...
        this.callCenterForm.get('fechFn').valueChanges.subscribe(change => {
            ...
            if(this.callCenterForm.get('fechIn').value) {
                ...
                this.router.navigate(['/reportes/conveniosRealizados'], { queryParams: { length: this.length, pageIndex: 1, fechFn: fechFn, fechIn: fechIn } });
    ...
    getSubscribeParams() {
        ...
        this.route.queryParams.subscribe(queryParams => {
            ...
            this.reportService.getConvenioRango(queryParams['fechIn'], queryParams['fechFn'], queryParams['pageIndex'])
                .then((data: any) => {
                    let creditos = [];
                    console.log(data);
    ...
    getServerData(event)  : any{
        ...
        this.router.navigate(['/reportes/conveniosRealizados'],
    ...
    export() {
        ...
        const fechFn = this.castdate(this.callCenterForm.get('fechFn').value);
            this.openSnackBar('cargando..');
            this.cobranzaService.activate();
            this.reportService.getbyFecCovenios(fechIn, fechFn).subscribe(fileData => {
